...
{
    [BudgetComponent(ComponentType.Map, "Lambda Map - Python", Language.PYTHON)]
    public class PythonLambdaMap : ComponentBase, ILambdaMap
    {

        /// <inheritdoc />
        public Language Lang => Language.PYTHON;
