...
{
    public class EmailSink : ComponentBase, ISink
    {
        ...
        public override string ImageTag => "registry-ui.donglinxu.com/budget/emailsink:latest";
        ...
        public override FunctionDefinition GenerateDeploymentManifest(string masterExchange, IConfiguration configuration)
        {
            var res = new FunctionDefinition
            {
                ...
                EnvVars = new Dictionary<string, string>()
                {
                    ...
                    { "Email__SenderUsername", configuration.GetValue<string>("Infrastructure:Email:SenderUsername") },
                    { "Email__SenderPassword", configuration.GetValue<string>("Infrastructure:Email:SenderPassword") },
                },
            };
            return res;
        }
