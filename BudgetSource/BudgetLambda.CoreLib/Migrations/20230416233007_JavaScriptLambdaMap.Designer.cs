...
namespace BudgetLambda.CoreLib.Migrations
{
    ...
    [Migration("20230416233007_JavaScriptLambdaMap")]
    partial class JavaScriptLambdaMap
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetLambda.CoreLib.Component.Map.JavaScriptLambdaMap", b =>
                {
                    b.HasBaseType("BudgetLambda.CoreLib.Component.ComponentBase");
                    ...
                    b.ToTable("Components", "Budget", t =>
                        {
                            t.Property("Code")
                                .HasColumnName("JavaScriptLambdaMap_Code");
                        });

                    b.HasDiscriminator().HasValue("JavaScriptLambdaMap");
                });
